...
class AvaliacaoController {
    ...
    def save(Avaliacao avaliacaoInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'avaliacaoInstance.label', default: 'Avaliacao'), avaliacaoInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'avaliacaoInstance.label', default: 'Avaliacao'), params.id])
                redirect action: "index", method: "GET"
            }
