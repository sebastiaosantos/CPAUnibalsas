...
<body>
	...
	<content tag="header">
		<header id="Header" class="jumbotron masthead">
			<div class="inner">
				<div class="container">
					<h1 class="title">Technical Info about SisCPA</h1>
					<p class="lead">This page presents some information about the SisCPA system.</p>
				</div>
			</div>
		</header>
	</content>
	...
	<section id="resources">
	    ...
	    <ul>
			<li>Web Layout: <a href ="http://twitter.github.com/bootstrap/">Bootstrap 3.0</a>, from Twitter </li>
