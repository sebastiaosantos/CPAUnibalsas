...
<html>
	...
	<body>
		...
		<div id="edit-_DemoPage" class="content scaffold-edit" role="main">
			...
			<ul class="alert alert-error" role="alert">
				<g:eachError bean="${_DemoPageInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:_DemoPageInstance, action:'update']" method="PUT"  class="form-horizontal"  enctype="multipart/form-data">
